...
function [T,sol] = NLinkPend_AMB(n,rederive,simulate,p,Y0,time)
...
if rederive == 1
    ...
    matlabFunction(A,'file','NLinkPend_A_AMB','Vars',{g,a,L,m,t,dt});
    matlabFunction(b,'file','NLinkPend_b_AMB','Vars',{g,a,L,m,t,dt});
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function dydt = odeAMB(~,y,p)
        ...
        th   = y(1:p.n)';
        dth  = y(p.n+1:2*p.n)';
        P    = NLinkPend_A_AMB(p.g,p.a,p.L,p.m,th,dth);
        q    = NLinkPend_b_AMB(p.g,p.a,p.L,p.m,th,dth);
        x    = P\q;
